...
const businessLinkSettingsSchema = new mongoose.Schema(
  {
    ...
    // Controls whether the saved Business Link logo is used as a sequence default.
    logoSuppressed: { type: Boolean, default: false },
    whatsappUrl: { type: String, required: true, trim: true },
    actionLinkIds: [
      { type: mongoose.Schema.Types.ObjectId, ref: "Social Link" },
    ],
...
businessLinkSettingsSchema.index(
  { userId: 1, businessType: 1 },
  { unique: true },
);
module.exports = mongoose.model(
  "Business Link Settings",
  businessLinkSettingsSchema,
);
