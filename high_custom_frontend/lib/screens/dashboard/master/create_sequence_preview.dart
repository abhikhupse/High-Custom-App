...
class CreateSequencePreview extends StatelessWidget {
  ...
  final List<Map<String, String>> actionLinks;
            ...
            builder: (context, constraints) {
              ...
              return Row(
                ...
                children: [
                  ...
                  SizedBox(width: 285, child: _buildMobilePreview()),
                ],
              );
            },
          ),
  ...
  Widget _buildDesktopPreview() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _previewTitle(Icons.desktop_windows_outlined, 'Desktop Preview'),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Center(
                      child: ConstrainedBox(
                        ...
                        child: _buildEmailTemplate(isMobile: false),
                      ),
                    ),
                  ),
                ),
  ...
  Widget _buildDesktopHeader() {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        border: Border(bottom: BorderSide(color: lightBorderColor)),
      ),
      child: Column(
        children: [
          // ======================================================
          ...
          Row(
            children: [
              ...
              const Icon(Icons.more_horiz, size: 18, color: secondaryTextColor),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  subject.isEmpty ? 'Your email subject' : subject,
                  maxLines: 2,
  ...
  Widget _buildMobilePreview() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _previewTitle(Icons.phone_android, 'Mobile Preview'),
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Icon(Icons.signal_cellular_alt, color: Colors.black, size: 10),

          SizedBox(width: 4),

          Icon(Icons.wifi, color: Colors.black, size: 10),

          SizedBox(width: 4),

          Icon(Icons.battery_full, color: Colors.black, size: 11),
        ],
      ),
    );
  }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      subject.isEmpty
                          ? 'Exclusive Jewellery Collection for You ✨'
                          : subject,
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                      style: const TextStyle(
                  ...
                  Container(
                    ...
                    child: const Text(
                      'Inbox',
                      style: TextStyle(color: Color(0xFF4B5563), fontSize: 7),
                    ),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  const Text(
                    '9:41 AM',
                    style: TextStyle(color: secondaryTextColor, fontSize: 7),
                  ),
        ...
        Expanded(
          child: Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: _buildEmailTemplate(isMobile: true),
            ),
          ),
        ),
      ],
  ...
  Widget _previewTitle(IconData icon, String title) {
    return Row(
      children: [
  ...
  Widget _buildEmailTemplate({required bool isMobile}) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
            ...
            // LOGO
            // ====================================================
            if (_hasLogo()) _buildLogoSection(isMobile: isMobile),

            // ====================================================
            // HERO IMAGE
            // ====================================================
            if (_hasHeroImage()) _buildHeroSection(isMobile: isMobile),
            ...
            if (whatsappController.text.trim().isNotEmpty)
              _buildWhatsAppButton(isMobile: isMobile),

            if (attachmentNameController.text.trim().isNotEmpty)
              _buildAttachment(isMobile: isMobile),
          ],
        ),
      ),
    );
  ...
  Widget _buildEmailBrandHeader({required bool isMobile}) {
    return Container(
      width: double.infinity,
  ...
  Widget _buildActualImage({
    ...
    if (path.isEmpty) {
      return Container(
        ...
        child: const Center(
          child: Icon(Icons.image_outlined, color: Color(0xFF98A2B3), size: 25),
        ),
      );
    }
    ...
    if (path.startsWith('http://') || path.startsWith('https://')) {
      return Image.network(
        ...
        errorBuilder: (context, error, stackTrace) {
          return _imageErrorBox(width, height);
        },
      );
    }
  ...
  Widget _imageErrorBox(double width, double height) {
    return Container(
      width: width,
      height: height,
      decoration: BoxDecoration(
  ...
  Widget _buildContent({required bool isMobile}) {
    ...
    return Text(
      content.isEmpty ? 'Your email content will appear here...' : content,
      style: TextStyle(
  ...
  Widget _buildCtaButton({required bool isMobile, String? label}) {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: isMobile ? 12 : 20,
        vertical: 6,
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: Text(
            label ?? ctaTextController.text.trim(),
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(
  ...
  Widget _buildWhatsAppButton({required bool isMobile}) {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: isMobile ? 12 : 20,
        vertical: 5,
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          onPressed: () {},
          icon: Icon(Icons.chat_outlined, size: isMobile ? 11 : 14),
          label: Text(
            'WhatsApp',
            style: TextStyle(
              fontSize: isMobile ? 9 : 11,
  ...
  Widget _buildAttachment({required bool isMobile}) {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: isMobile ? 12 : 20,
        vertical: 6,
  ...
  Widget _buildFooter({required bool isMobile}) {
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        border: Border(top: BorderSide(color: lightBorderColor)),
      ),
      child: Text(
